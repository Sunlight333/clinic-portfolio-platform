      ...
      <div className="container-x relative">
        <Reveal direction="scale">
          <div className="shape-arch-soft relative overflow-hidden border-[6px] border-white shadow-float">
            ...
            <span
              aria-hidden
              className="absolute inset-0 bg-[linear-gradient(125deg,rgba(249,112,74,.94)_0%,rgba(242,118,156,.9)_46%,rgba(139,110,240,.88)_100%)]"
            />
            <span
              aria-hidden
            ...
            <div className="relative flex flex-col items-center gap-10 px-6 py-16 text-center sm:px-12 sm:py-20 lg:flex-row lg:justify-between lg:text-left">
              <div className="max-w-2xl">
                ...
                <p className="mt-5 max-w-[56ch] text-[1.1rem] leading-relaxed text-white/92">
                  {dict.cta.lead}
                </p>
                ...
                <p className="mt-7 flex items-center justify-center gap-2.5 text-[0.92rem] font-bold text-white/85 lg:justify-start">
